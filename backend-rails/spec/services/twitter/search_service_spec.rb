describe Twitter::SearchService do
  ...
  describe '#call' do
    ...
    let(:tweet_1) { OpenStruct.new(id: 9817238193121,text: 'sample text for 1', url: 'https://localhost/1') }
    let(:tweet_2) { OpenStruct.new(id: 9817238193122,text: 'sample text for 2', url: 'https://localhost/2') }
    let(:tweet_3) { OpenStruct.new(id: 9817238193123,text: 'sample text for 3', url: 'https://localhost/3') }
